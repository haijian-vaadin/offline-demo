...
export class MainView extends LitElement {
  ...
  @property({ type: Array }) menuTabs: MenuTab[] = [
    {route: 'ts-person-form', name: 'TS-Person-Form'},
    {route: 'ts-master-detail', name: 'TS-Master-Detail'},
    {route: 'java-empty', name: 'Java-Empty'},
  ];
